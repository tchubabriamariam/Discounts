...
namespace Discounts.Application.Services.Interfaces
{
    public interface ICategoryService
    {
        ...
        Task<CategoryResponseDto>
            DeactivateCategoryAsync(int categoryId, CancellationToken cancellationToken = default);

        Task<IEnumerable<CategoryResponseDto>> GetAllCategoriesAsync(bool includeInactive,
            CancellationToken cancellationToken = default);
