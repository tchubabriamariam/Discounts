...
namespace Discounts.API.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        {
            var result = await _adminService.GetAllUsersAsync(roleFilter, cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        {
            var result = await _adminService.GetUserByIdAsync(id, cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> UpdateUser(
            ...
            CancellationToken cancellationToken)
        {
            var result = await _adminService.UpdateUserAsync(id, request, cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
