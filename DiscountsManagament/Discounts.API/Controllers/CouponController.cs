...
namespace Discounts.API.Controllers
{
    ...
    public class CouponController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMyCoupons(CancellationToken cancellationToken)
        {
            ...
            var result = await _couponService.GetMyCouponsAsync(userId, cancellationToken).ConfigureAwait(false);
            ...
            CancellationToken cancellationToken)
        {
            ...
            return Ok(new { message = "Coupon marked as used successfully.", coupon = result });
        }
    }
}
