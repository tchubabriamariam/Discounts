...
namespace Discounts.API.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        {
            var result = await _categoryService.GetActiveCategoriesAsync(cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        {
            var result = await _categoryService.GetCategoryByIdAsync(id, cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        {
            var result = await _categoryService.CreateCategoryAsync(request, cancellationToken).ConfigureAwait(false);
        ...
        {
            var result = await _categoryService.ActivateCategoryAsync(id, cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        {
            var result = await _categoryService.DeactivateCategoryAsync(id, cancellationToken).ConfigureAwait(false);
            return Ok(result);
        }
    }
}
