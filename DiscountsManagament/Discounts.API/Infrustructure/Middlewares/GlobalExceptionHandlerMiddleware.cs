        ...
        private Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            var errorResponse = exception switch
            {
                ...
                FluentValidation.ValidationException fluentEx => new ErrorResponse
                {
                    ...
                    Details = JsonSerializer.Serialize(fluentEx.Errors.Select(e =>
                        new { e.PropertyName, e.ErrorMessage }))
                },
                BusinessRuleViolationException businessEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.BadRequest, Message = businessEx.Message
                },
                InvalidOperationException invalidOpEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.BadRequest, Message = invalidOpEx.Message
                },
                ArgumentException argEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.BadRequest, Message = argEx.Message
                },

                // 401 - Unauthorized
                UnauthorizedException unauthorizedEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.Unauthorized, Message = unauthorizedEx.Message
                },
                UnauthorizedAccessException unauthorizedAccessEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.Unauthorized, Message = unauthorizedAccessEx.Message
                },

                // 403 - Forbidden
                ForbiddenException forbiddenEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.Forbidden, Message = forbiddenEx.Message
                },

                // 404 - Not Found
                NotFoundException notFoundEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.NotFound, Message = notFoundEx.Message
                },

                // 409 - Conflict
                AlreadyExistsException existsEx => new ErrorResponse
                {
                    StatusCode = (int)HttpStatusCode.Conflict, Message = existsEx.Message
                },
